...
namespace OpenAPI\ShopwareAdminApiClient;
...
class Configuration
{
    ...
    {
        $report  = 'PHP SDK (OpenAPI\ShopwareAdminApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 6.5.8.0' . PHP_EOL;
