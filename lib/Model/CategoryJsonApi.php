...
class CategoryJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setProductStreamId($product_stream_id)
    {
        ...
        if (!is_null($product_stream_id) && (!preg_match("/^[0-9a-f]{32}$/", $product_stream_id))) {
            throw new \InvalidArgumentException("invalid value for $product_stream_id when calling CategoryJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomEntityTypeId($custom_entity_type_id)
    {
        ...
        if (!is_null($custom_entity_type_id) && (!preg_match("/^[0-9a-f]{32}$/", $custom_entity_type_id))) {
            throw new \InvalidArgumentException("invalid value for $custom_entity_type_id when calling CategoryJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
