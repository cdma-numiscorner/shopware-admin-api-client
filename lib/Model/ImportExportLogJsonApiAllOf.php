...
/**
 * ImportExportLogJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ImportExportLogJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportExportLogJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ImportExportLogJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if (!is_null($user_id) && (!preg_match("/^[0-9a-f]{32}$/", $user_id))) {
            throw new \InvalidArgumentException("invalid value for $user_id when calling ImportExportLogJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setProfileId($profile_id)
    {
        ...
        if (!is_null($profile_id) && (!preg_match("/^[0-9a-f]{32}$/", $profile_id))) {
            throw new \InvalidArgumentException("invalid value for $profile_id when calling ImportExportLogJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setFileId($file_id)
    {
        ...
        if (!is_null($file_id) && (!preg_match("/^[0-9a-f]{32}$/", $file_id))) {
            throw new \InvalidArgumentException("invalid value for $file_id when calling ImportExportLogJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setInvalidRecordsLogId($invalid_records_log_id)
    {
        ...
        if (!is_null($invalid_records_log_id) && (!preg_match("/^[0-9a-f]{32}$/", $invalid_records_log_id))) {
            throw new \InvalidArgumentException("invalid value for $invalid_records_log_id when calling ImportExportLogJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
