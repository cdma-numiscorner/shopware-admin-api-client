...
/**
 * ProductProperty Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProperty';
    ...
    protected static $openAPITypes = [
        ...
        'option' => '\OpenAPI\ShopwareAdminApiClient\Model\PropertyGroupOption'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductProperty., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setProductId($product_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $product_id))) {
            throw new \InvalidArgumentException("invalid value for $product_id when calling ProductProperty., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setProductVersionId($product_version_id)
    {
        ...
        if (!is_null($product_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $product_version_id))) {
            throw new \InvalidArgumentException("invalid value for $product_version_id when calling ProductProperty., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOptionId($option_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $option_id))) {
            throw new \InvalidArgumentException("invalid value for $option_id when calling ProductProperty., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets option
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\PropertyGroupOption|null $option option
     *
     * @return self
     */
