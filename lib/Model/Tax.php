...
class Tax implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'rules' => '\OpenAPI\ShopwareAdminApiClient\Model\TaxRule[]',
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling Tax., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets rules
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\TaxRule[]|null $rules rules
     *
     * @return self
     */
