 ...
 */
class CmsSlotJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CmsSlotJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CmsSlotJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling CmsSlotJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBlockId($block_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $block_id))) {
            throw new \InvalidArgumentException("invalid value for $block_id when calling CmsSlotJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsBlockVersionId($cms_block_version_id)
    {
        ...
        if (!is_null($cms_block_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_block_version_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_block_version_id when calling CmsSlotJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
