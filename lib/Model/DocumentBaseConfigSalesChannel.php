...
/**
 * DocumentBaseConfigSalesChannel Class Doc Comment
 *
 * @category Class
 ...
 */
class DocumentBaseConfigSalesChannel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentBaseConfigSalesChannel';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'document_type' => '\OpenAPI\ShopwareAdminApiClient\Model\DocumentType',
        'document_base_config' => '\OpenAPI\ShopwareAdminApiClient\Model\DocumentBaseConfig',
    ...
    protected static $setters = [
        ...
        'document_base_config' => 'setDocumentBaseConfig',
    ...
    protected static $getters = [
        ...
        'document_base_config' => 'getDocumentBaseConfig',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['document_base_config_id'] = $data['document_base_config_id'] ?? null;
        ...
        $this->container['document_base_config'] = $data['document_base_config'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9a-f]{32}$/", $this->container['document_base_config_id'])) {
            $invalidProperties[] = "invalid value for 'document_base_config_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }
        ...
        if (!is_null($this->container['document_type_id']) && !preg_match("/^[0-9a-f]{32}$/", $this->container['document_type_id'])) {
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling DocumentBaseConfigSalesChannel., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDocumentBaseConfigId($document_base_config_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $document_base_config_id))) {
            throw new \InvalidArgumentException("invalid value for $document_base_config_id when calling DocumentBaseConfigSalesChannel., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if (!is_null($sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling DocumentBaseConfigSalesChannel., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDocumentTypeId($document_type_id)
    {
        ...
        if (!is_null($document_type_id) && (!preg_match("/^[0-9a-f]{32}$/", $document_type_id))) {
            throw new \InvalidArgumentException("invalid value for $document_type_id when calling DocumentBaseConfigSalesChannel., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets document_type
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\DocumentType|null
     */
     ...
     * Sets document_type
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\DocumentType|null $document_type document_type
     *
     * @return self
     */
    ...
    {
        return $this->container['document_base_config'];
    }

    /**
     * Sets document_base_config
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\DocumentBaseConfig|null $document_base_config document_base_config
     *
     * @return self
     */
    public function setDocumentBaseConfig($document_base_config)
    {
        $this->container['document_base_config'] = $document_base_config;
