...
/**
 * CustomerJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setGroupId($group_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $group_id))) {
            throw new \InvalidArgumentException("invalid value for $group_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultPaymentMethodId($default_payment_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $default_payment_method_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLastPaymentMethodId($last_payment_method_id)
    {
        ...
        if (!is_null($last_payment_method_id) && (!preg_match("/^[0-9a-f]{32}$/", $last_payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $last_payment_method_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultBillingAddressId($default_billing_address_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_billing_address_id))) {
            throw new \InvalidArgumentException("invalid value for $default_billing_address_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultShippingAddressId($default_shipping_address_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_shipping_address_id))) {
            throw new \InvalidArgumentException("invalid value for $default_shipping_address_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalutationId($salutation_id)
    {
        ...
        if (!is_null($salutation_id) && (!preg_match("/^[0-9a-f]{32}$/", $salutation_id))) {
            throw new \InvalidArgumentException("invalid value for $salutation_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setRequestedGroupId($requested_group_id)
    {
        ...
        if (!is_null($requested_group_id) && (!preg_match("/^[0-9a-f]{32}$/", $requested_group_id))) {
            throw new \InvalidArgumentException("invalid value for $requested_group_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBoundSalesChannelId($bound_sales_channel_id)
    {
        ...
        if (!is_null($bound_sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $bound_sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $bound_sales_channel_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCreatedById($created_by_id)
    {
        ...
        if (!is_null($created_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $created_by_id))) {
            throw new \InvalidArgumentException("invalid value for $created_by_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUpdatedById($updated_by_id)
    {
        ...
        if (!is_null($updated_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $updated_by_id))) {
            throw new \InvalidArgumentException("invalid value for $updated_by_id when calling CustomerJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CustomerJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
