 ...
 */
class SnippetSet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnippetSet';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'snippets' => '\OpenAPI\ShopwareAdminApiClient\Model\Snippet[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['base_file'] = $data['base_file'] ?? null;
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SnippetSet., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets snippets
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\Snippet[]|null
     */
     ...
     * Sets snippets
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Snippet[]|null $snippets snippets
     *
     * @return self
     */
