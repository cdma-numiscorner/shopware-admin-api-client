...
class InlineObject275 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $state_field_name This is the state column within the order transaction database table. There should be no need to change it from the default.
     *
     * @return self
     */
