...
/**
 * ProductFeatureSetJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductFeatureSetJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductFeatureSetJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductFeatureSetJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
