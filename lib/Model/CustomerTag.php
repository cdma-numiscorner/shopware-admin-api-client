...
class CustomerTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CustomerTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $customer_id))) {
            throw new \InvalidArgumentException("invalid value for $customer_id when calling CustomerTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTagId($tag_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $tag_id))) {
            throw new \InvalidArgumentException("invalid value for $tag_id when calling CustomerTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
