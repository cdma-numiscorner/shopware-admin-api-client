...
/**
 * ShippingMethodJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ShippingMethodJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingMethodJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ShippingMethodJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAvailabilityRuleId($availability_rule_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $availability_rule_id))) {
            throw new \InvalidArgumentException("invalid value for $availability_rule_id when calling ShippingMethodJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMediaId($media_id)
    {
        ...
        if (!is_null($media_id) && (!preg_match("/^[0-9a-f]{32}$/", $media_id))) {
            throw new \InvalidArgumentException("invalid value for $media_id when calling ShippingMethodJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDeliveryTimeId($delivery_time_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $delivery_time_id))) {
            throw new \InvalidArgumentException("invalid value for $delivery_time_id when calling ShippingMethodJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTaxId($tax_id)
    {
        ...
        if (!is_null($tax_id) && (!preg_match("/^[0-9a-f]{32}$/", $tax_id))) {
            throw new \InvalidArgumentException("invalid value for $tax_id when calling ShippingMethodJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
