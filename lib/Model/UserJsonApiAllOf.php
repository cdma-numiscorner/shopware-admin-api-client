...
/**
 * UserJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class UserJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\UserJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling UserJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLocaleId($locale_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $locale_id))) {
            throw new \InvalidArgumentException("invalid value for $locale_id when calling UserJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAvatarId($avatar_id)
    {
        ...
        if (!is_null($avatar_id) && (!preg_match("/^[0-9a-f]{32}$/", $avatar_id))) {
            throw new \InvalidArgumentException("invalid value for $avatar_id when calling UserJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\UserJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\UserJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
