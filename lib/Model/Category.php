...
class Category implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'parent' => '\OpenAPI\ShopwareAdminApiClient\Model\Category',
        'children' => '\OpenAPI\ShopwareAdminApiClient\Model\Category[]',
        'media' => '\OpenAPI\ShopwareAdminApiClient\Model\Media',
        'products' => '\OpenAPI\ShopwareAdminApiClient\Model\Product[]',
        'nested_products' => '\OpenAPI\ShopwareAdminApiClient\Model\Product[]',
        ...
        'navigation_sales_channels' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]',
        'footer_sales_channels' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]',
        'service_sales_channels' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]',
    ...
    public function setCustomEntityTypeId($custom_entity_type_id)
    {
        ...
        if (!is_null($custom_entity_type_id) && (!preg_match("/^[0-9a-f]{32}$/", $custom_entity_type_id))) {
            throw new \InvalidArgumentException("invalid value for $custom_entity_type_id when calling Category., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets parent
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Category|null $parent parent
     *
     * @return self
     */
     ...
     * Sets children
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Category[]|null $children children
     *
     * @return self
     */
     ...
     * Sets products
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Product[]|null $products products
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Product[]|null $nested_products nested_products
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]|null $navigation_sales_channels navigation_sales_channels
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]|null $footer_sales_channels footer_sales_channels
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SalesChannel[]|null $service_sales_channels service_sales_channels
     *
     * @return self
     */
