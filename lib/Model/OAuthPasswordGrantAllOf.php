...
/**
 * OAuthPasswordGrantAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class OAuthPasswordGrantAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAuthPasswordGrant_allOf';
     ...
     * Sets password
     *
     * @param string $password Password of the user that should be authenticated.
     *
     * @return self
     */
