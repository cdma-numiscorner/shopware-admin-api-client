...
/**
 * SystemConfigJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SystemConfigJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SystemConfigJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'configuration_value' => '\OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfConfigurationValue',
        'sales_channel_id' => 'string',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SystemConfigJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfConfigurationValue
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfConfigurationValue $configuration_value configuration_value
     *
     * @return self
     */
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if (!is_null($sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling SystemConfigJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SystemConfigJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
