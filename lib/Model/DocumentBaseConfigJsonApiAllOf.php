...
/**
 * DocumentBaseConfigJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class DocumentBaseConfigJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentBaseConfigJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling DocumentBaseConfigJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDocumentTypeId($document_type_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $document_type_id))) {
            throw new \InvalidArgumentException("invalid value for $document_type_id when calling DocumentBaseConfigJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLogoId($logo_id)
    {
        ...
        if (!is_null($logo_id) && (!preg_match("/^[0-9a-f]{32}$/", $logo_id))) {
            throw new \InvalidArgumentException("invalid value for $logo_id when calling DocumentBaseConfigJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
