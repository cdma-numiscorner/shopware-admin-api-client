...
/**
 * CmsSectionJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CmsSectionJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CmsSectionJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CmsSectionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBackgroundMediaId($background_media_id)
    {
        ...
        if (!is_null($background_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $background_media_id))) {
            throw new \InvalidArgumentException("invalid value for $background_media_id when calling CmsSectionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPageId($page_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $page_id))) {
            throw new \InvalidArgumentException("invalid value for $page_id when calling CmsSectionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling CmsSectionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsPageVersionId($cms_page_version_id)
    {
        ...
        if (!is_null($cms_page_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_page_version_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_page_version_id when calling CmsSectionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
