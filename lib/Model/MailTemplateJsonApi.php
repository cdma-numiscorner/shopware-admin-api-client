...
/**
 * MailTemplateJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class MailTemplateJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailTemplateJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling MailTemplateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMailTemplateTypeId($mail_template_type_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $mail_template_type_id))) {
            throw new \InvalidArgumentException("invalid value for $mail_template_type_id when calling MailTemplateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
