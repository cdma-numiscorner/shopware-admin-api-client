...
/**
 * ProductStream Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductStream implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductStream';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'filters' => '\OpenAPI\ShopwareAdminApiClient\Model\ProductStreamFilter[]',
        'product_cross_sellings' => '\OpenAPI\ShopwareAdminApiClient\Model\ProductCrossSelling[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['api_filter'] = $data['api_filter'] ?? null;
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductStream., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets api_filter
     *
     * @param object|null $api_filter api_filter
     *
     * @return self
     */
     ...
     * Sets filters
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\ProductStreamFilter[]|null $filters filters
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\ProductCrossSelling[]|null $product_cross_sellings product_cross_sellings
     *
     * @return self
     */
