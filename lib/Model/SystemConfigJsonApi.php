...
/**
 * SystemConfigJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class SystemConfigJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SystemConfigJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SystemConfigJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if (!is_null($sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling SystemConfigJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
