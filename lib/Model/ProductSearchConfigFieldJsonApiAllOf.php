...
/**
 * ProductSearchConfigFieldJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ProductSearchConfigFieldJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductSearchConfigFieldJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductSearchConfigFieldJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSearchConfigId($search_config_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $search_config_id))) {
            throw new \InvalidArgumentException("invalid value for $search_config_id when calling ProductSearchConfigFieldJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomFieldId($custom_field_id)
    {
        ...
        if (!is_null($custom_field_id) && (!preg_match("/^[0-9a-f]{32}$/", $custom_field_id))) {
            throw new \InvalidArgumentException("invalid value for $custom_field_id when calling ProductSearchConfigFieldJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
