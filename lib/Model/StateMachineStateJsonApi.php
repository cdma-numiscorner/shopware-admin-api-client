...
/**
 * StateMachineStateJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class StateMachineStateJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StateMachineStateJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling StateMachineStateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setStateMachineId($state_machine_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $state_machine_id))) {
            throw new \InvalidArgumentException("invalid value for $state_machine_id when calling StateMachineStateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
