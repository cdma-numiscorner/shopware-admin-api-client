...
/**
 * SalesChannelJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SalesChannelJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesChannelJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTypeId($type_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $type_id))) {
            throw new \InvalidArgumentException("invalid value for $type_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomerGroupId($customer_group_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $customer_group_id))) {
            throw new \InvalidArgumentException("invalid value for $customer_group_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $currency_id))) {
            throw new \InvalidArgumentException("invalid value for $currency_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPaymentMethodId($payment_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $payment_method_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $shipping_method_id))) {
            throw new \InvalidArgumentException("invalid value for $shipping_method_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $country_id))) {
            throw new \InvalidArgumentException("invalid value for $country_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAnalyticsId($analytics_id)
    {
        ...
        if (!is_null($analytics_id) && (!preg_match("/^[0-9a-f]{32}$/", $analytics_id))) {
            throw new \InvalidArgumentException("invalid value for $analytics_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setNavigationCategoryId($navigation_category_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $navigation_category_id))) {
            throw new \InvalidArgumentException("invalid value for $navigation_category_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setNavigationCategoryVersionId($navigation_category_version_id)
    {
        ...
        if (!is_null($navigation_category_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $navigation_category_version_id))) {
            throw new \InvalidArgumentException("invalid value for $navigation_category_version_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setFooterCategoryId($footer_category_id)
    {
        ...
        if (!is_null($footer_category_id) && (!preg_match("/^[0-9a-f]{32}$/", $footer_category_id))) {
            throw new \InvalidArgumentException("invalid value for $footer_category_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setFooterCategoryVersionId($footer_category_version_id)
    {
        ...
        if (!is_null($footer_category_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $footer_category_version_id))) {
            throw new \InvalidArgumentException("invalid value for $footer_category_version_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setServiceCategoryId($service_category_id)
    {
        ...
        if (!is_null($service_category_id) && (!preg_match("/^[0-9a-f]{32}$/", $service_category_id))) {
            throw new \InvalidArgumentException("invalid value for $service_category_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setServiceCategoryVersionId($service_category_version_id)
    {
        ...
        if (!is_null($service_category_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $service_category_version_id))) {
            throw new \InvalidArgumentException("invalid value for $service_category_version_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMailHeaderFooterId($mail_header_footer_id)
    {
        ...
        if (!is_null($mail_header_footer_id) && (!preg_match("/^[0-9a-f]{32}$/", $mail_header_footer_id))) {
            throw new \InvalidArgumentException("invalid value for $mail_header_footer_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setHreflangDefaultDomainId($hreflang_default_domain_id)
    {
        ...
        if (!is_null($hreflang_default_domain_id) && (!preg_match("/^[0-9a-f]{32}$/", $hreflang_default_domain_id))) {
            throw new \InvalidArgumentException("invalid value for $hreflang_default_domain_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setHomeCmsPageId($home_cms_page_id)
    {
        ...
        if (!is_null($home_cms_page_id) && (!preg_match("/^[0-9a-f]{32}$/", $home_cms_page_id))) {
            throw new \InvalidArgumentException("invalid value for $home_cms_page_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setHomeCmsPageVersionId($home_cms_page_version_id)
    {
        ...
        if (!is_null($home_cms_page_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $home_cms_page_version_id))) {
            throw new \InvalidArgumentException("invalid value for $home_cms_page_version_id when calling SalesChannelJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
