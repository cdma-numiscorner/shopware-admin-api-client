...
/**
 * OrderDeliveryPositionJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class OrderDeliveryPositionJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDeliveryPositionJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\OrderDeliveryPositionJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderDeliveryId($order_delivery_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $order_delivery_id))) {
            throw new \InvalidArgumentException("invalid value for $order_delivery_id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderDeliveryVersionId($order_delivery_version_id)
    {
        ...
        if (!is_null($order_delivery_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $order_delivery_version_id))) {
            throw new \InvalidArgumentException("invalid value for $order_delivery_version_id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemId($order_line_item_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $order_line_item_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemVersionId($order_line_item_version_id)
    {
        ...
        if (!is_null($order_line_item_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $order_line_item_version_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_version_id when calling OrderDeliveryPositionJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets price
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\OrderJsonApiAllOfShippingCosts|null $price price
     *
     * @return self
     */
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\OrderDeliveryPositionJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\OrderDeliveryPositionJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
