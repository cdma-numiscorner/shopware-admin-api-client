...
class FlowSequence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'flow' => '\OpenAPI\ShopwareAdminApiClient\Model\Flow',
        'rule' => '\OpenAPI\ShopwareAdminApiClient\Model\Rule',
        'parent' => '\OpenAPI\ShopwareAdminApiClient\Model\FlowSequence',
        'children' => '\OpenAPI\ShopwareAdminApiClient\Model\FlowSequence[]',
        'app_flow_action' => '\OpenAPI\ShopwareAdminApiClient\Model\AppFlowAction'
    ];
    ...
    public function setAppFlowActionId($app_flow_action_id)
    {
        ...
        if (!is_null($app_flow_action_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_flow_action_id))) {
            throw new \InvalidArgumentException("invalid value for $app_flow_action_id when calling FlowSequence., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets flow
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\Flow|null
     */
     ...
     * Sets flow
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Flow|null $flow flow
     *
     * @return self
     */
     ...
     * Sets parent
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\FlowSequence|null $parent parent
     *
     * @return self
     */
     ...
     * Sets children
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\FlowSequence[]|null $children children
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\AppFlowAction|null $app_flow_action app_flow_action
     *
     * @return self
     */
