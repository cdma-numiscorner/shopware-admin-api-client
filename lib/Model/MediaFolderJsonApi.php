...
/**
 * MediaFolderJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class MediaFolderJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaFolderJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling MediaFolderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setConfigurationId($configuration_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $configuration_id))) {
            throw new \InvalidArgumentException("invalid value for $configuration_id when calling MediaFolderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultFolderId($default_folder_id)
    {
        ...
        if (!is_null($default_folder_id) && (!preg_match("/^[0-9a-f]{32}$/", $default_folder_id))) {
            throw new \InvalidArgumentException("invalid value for $default_folder_id when calling MediaFolderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_id when calling MediaFolderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
