 ...
 */
class MediaTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaTag';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling MediaTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMediaId($media_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $media_id))) {
            throw new \InvalidArgumentException("invalid value for $media_id when calling MediaTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTagId($tag_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $tag_id))) {
            throw new \InvalidArgumentException("invalid value for $tag_id when calling MediaTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
