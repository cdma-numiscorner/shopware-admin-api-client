...
/**
 * ThemeJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ThemeJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThemeJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\ThemeJsonApiAllOfRelationships'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['theme_json'] = $data['theme_json'] ?? null;
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ThemeJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPreviewMediaId($preview_media_id)
    {
        ...
        if (!is_null($preview_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $preview_media_id))) {
            throw new \InvalidArgumentException("invalid value for $preview_media_id when calling ThemeJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentThemeId($parent_theme_id)
    {
        ...
        if (!is_null($parent_theme_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_theme_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_theme_id when calling ThemeJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    {
        return $this->container['theme_json'];
    }

    /**
     * Sets theme_json
     *
     * @param object|null $theme_json theme_json
     *
     * @return self
     */
    public function setThemeJson($theme_json)
    {
        $this->container['theme_json'] = $theme_json;
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\ThemeJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\ThemeJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
