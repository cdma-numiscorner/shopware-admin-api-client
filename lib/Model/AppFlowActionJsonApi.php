...
/**
 * AppFlowActionJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class AppFlowActionJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppFlowActionJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling AppFlowActionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling AppFlowActionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
