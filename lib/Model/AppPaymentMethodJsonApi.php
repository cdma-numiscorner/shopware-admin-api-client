 ...
 */
class AppPaymentMethodJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppPaymentMethodJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling AppPaymentMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if (!is_null($app_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling AppPaymentMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOriginalMediaId($original_media_id)
    {
        ...
        if (!is_null($original_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $original_media_id))) {
            throw new \InvalidArgumentException("invalid value for $original_media_id when calling AppPaymentMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPaymentMethodId($payment_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $payment_method_id when calling AppPaymentMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
