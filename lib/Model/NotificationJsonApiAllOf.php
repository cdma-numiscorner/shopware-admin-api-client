...
/**
 * NotificationJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class NotificationJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling NotificationJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCreatedByIntegrationId($created_by_integration_id)
    {
        ...
        if (!is_null($created_by_integration_id) && (!preg_match("/^[0-9a-f]{32}$/", $created_by_integration_id))) {
            throw new \InvalidArgumentException("invalid value for $created_by_integration_id when calling NotificationJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCreatedByUserId($created_by_user_id)
    {
        ...
        if (!is_null($created_by_user_id) && (!preg_match("/^[0-9a-f]{32}$/", $created_by_user_id))) {
            throw new \InvalidArgumentException("invalid value for $created_by_user_id when calling NotificationJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
