...
class InlineObject270 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sender_email' => 'string',
        'media_ids' => 'string[]',
        'bin_attachments' => '\OpenAPI\ShopwareAdminApiClient\Model\ActionMailTemplateSendBinAttachments[]',
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling InlineObject270., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\ActionMailTemplateSendBinAttachments[]|null
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\ActionMailTemplateSendBinAttachments[]|null $bin_attachments A list of binary attachments which should be added to the mail.
     *
     * @return self
     */
     ...
     * Sets recipients_bcc
     *
     * @param map[string,string]|null $recipients_bcc A list of recipients with name and mail address to be set in BCC.
     *
     * @return self
     */
     ...
     * Sets recipients_cc
     *
     * @param map[string,string]|null $recipients_cc A list of recipients with name and mail address to be set in CC.
     *
     * @return self
     */
     ...
     * Sets reply_to
     *
     * @param map[string,string]|null $reply_to A list of mail addresses with name and mail address to be set in reply to.
     *
     * @return self
     */
     ...
     * Sets return_path
     *
     * @param map[string,string]|null $return_path A list of mail addresses with name and mail address to be set in return path.
     *
     * @return self
     */
