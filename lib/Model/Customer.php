...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'group' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerGroup',
        'default_payment_method' => '\OpenAPI\ShopwareAdminApiClient\Model\PaymentMethod',
        'sales_channel' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannel',
        'language' => '\OpenAPI\ShopwareAdminApiClient\Model\Language',
        'last_payment_method' => '\OpenAPI\ShopwareAdminApiClient\Model\PaymentMethod',
        'default_billing_address' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress',
        'default_shipping_address' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress',
        'salutation' => '\OpenAPI\ShopwareAdminApiClient\Model\Salutation',
        'addresses' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress[]',
        'order_customers' => '\OpenAPI\ShopwareAdminApiClient\Model\OrderCustomer[]',
        'tags' => '\OpenAPI\ShopwareAdminApiClient\Model\Tag[]',
        'promotions' => '\OpenAPI\ShopwareAdminApiClient\Model\Promotion[]',
        'product_reviews' => '\OpenAPI\ShopwareAdminApiClient\Model\ProductReview[]',
        'recovery_customer' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerRecovery',
        'requested_group' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerGroup',
        'bound_sales_channel' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannel',
        'wishlists' => '\OpenAPI\ShopwareAdminApiClient\Model\CustomerWishlist[]',
        'created_by' => '\OpenAPI\ShopwareAdminApiClient\Model\User',
        'updated_by' => '\OpenAPI\ShopwareAdminApiClient\Model\User'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['order_total_amount'] = $data['order_total_amount'] ?? null;
        ...
        $this->container['requested_group_id'] = $data['requested_group_id'] ?? null;
        $this->container['bound_sales_channel_id'] = $data['bound_sales_channel_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9a-f]{32}$/", $this->container['default_payment_method_id'])) {
            $invalidProperties[] = "invalid value for 'default_payment_method_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }
        ...
        if (!is_null($this->container['last_payment_method_id']) && !preg_match("/^[0-9a-f]{32}$/", $this->container['last_payment_method_id'])) {
            $invalidProperties[] = "invalid value for 'last_payment_method_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }

        if ($this->container['default_billing_address_id'] === null) {
            $invalidProperties[] = "'default_billing_address_id' can't be null";
        }
        if (!preg_match("/^[0-9a-f]{32}$/", $this->container['default_billing_address_id'])) {
            $invalidProperties[] = "invalid value for 'default_billing_address_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }

        if ($this->container['default_shipping_address_id'] === null) {
            $invalidProperties[] = "'default_shipping_address_id' can't be null";
        }
        if (!preg_match("/^[0-9a-f]{32}$/", $this->container['default_shipping_address_id'])) {
            $invalidProperties[] = "invalid value for 'default_shipping_address_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }
        ...
        if (!is_null($this->container['requested_group_id']) && !preg_match("/^[0-9a-f]{32}$/", $this->container['requested_group_id'])) {
            $invalidProperties[] = "invalid value for 'requested_group_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }

        if (!is_null($this->container['bound_sales_channel_id']) && !preg_match("/^[0-9a-f]{32}$/", $this->container['bound_sales_channel_id'])) {
            $invalidProperties[] = "invalid value for 'bound_sales_channel_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setGroupId($group_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $group_id))) {
            throw new \InvalidArgumentException("invalid value for $group_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultPaymentMethodId($default_payment_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $default_payment_method_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLastPaymentMethodId($last_payment_method_id)
    {
        ...
        if (!is_null($last_payment_method_id) && (!preg_match("/^[0-9a-f]{32}$/", $last_payment_method_id))) {
            throw new \InvalidArgumentException("invalid value for $last_payment_method_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultBillingAddressId($default_billing_address_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_billing_address_id))) {
            throw new \InvalidArgumentException("invalid value for $default_billing_address_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDefaultShippingAddressId($default_shipping_address_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $default_shipping_address_id))) {
            throw new \InvalidArgumentException("invalid value for $default_shipping_address_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalutationId($salutation_id)
    {
        ...
        if (!is_null($salutation_id) && (!preg_match("/^[0-9a-f]{32}$/", $salutation_id))) {
            throw new \InvalidArgumentException("invalid value for $salutation_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     *
     * @param float|null $order_total_amount order_total_amount
     *
     * @return self
     */
     ...
     *
     * @param string|null $requested_group_id requested_group_id
     *
     * @return self
     */
    public function setRequestedGroupId($requested_group_id)
    {
        ...
        if (!is_null($requested_group_id) && (!preg_match("/^[0-9a-f]{32}$/", $requested_group_id))) {
            throw new \InvalidArgumentException("invalid value for $requested_group_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     *
     * @param string|null $bound_sales_channel_id bound_sales_channel_id
     *
     * @return self
     */
    public function setBoundSalesChannelId($bound_sales_channel_id)
    {
        ...
        if (!is_null($bound_sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $bound_sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $bound_sales_channel_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCreatedById($created_by_id)
    {
        ...
        if (!is_null($created_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $created_by_id))) {
            throw new \InvalidArgumentException("invalid value for $created_by_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUpdatedById($updated_by_id)
    {
        ...
        if (!is_null($updated_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $updated_by_id))) {
            throw new \InvalidArgumentException("invalid value for $updated_by_id when calling Customer., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets group
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CustomerGroup|null
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerGroup|null $group group
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\PaymentMethod|null $default_payment_method default_payment_method
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\PaymentMethod|null $last_payment_method last_payment_method
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress|null
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress|null $default_billing_address default_billing_address
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress|null $default_shipping_address default_shipping_address
     *
     * @return self
     */
     ...
     * Sets addresses
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerAddress[]|null $addresses addresses
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\OrderCustomer[]|null
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\OrderCustomer[]|null $order_customers order_customers
     *
     * @return self
     */
     ...
     * Sets promotions
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\Promotion[]|null $promotions promotions
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\ProductReview[]|null
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\ProductReview[]|null $product_reviews product_reviews
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CustomerRecovery|null
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerRecovery|null $recovery_customer recovery_customer
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerGroup|null $requested_group requested_group
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SalesChannel|null $bound_sales_channel bound_sales_channel
     *
     * @return self
     */
     ...
     * Gets wishlists
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CustomerWishlist[]|null
     */
     ...
     * Sets wishlists
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CustomerWishlist[]|null $wishlists wishlists
     *
     * @return self
     */
     ...
     * Sets created_by
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\User|null $created_by created_by
     *
     * @return self
     */
     ...
     * Sets updated_by
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\User|null $updated_by updated_by
     *
     * @return self
     */
