...
/**
 * CountryStateJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class CountryStateJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountryStateJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CountryStateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $country_id))) {
            throw new \InvalidArgumentException("invalid value for $country_id when calling CountryStateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
