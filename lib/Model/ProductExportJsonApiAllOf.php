...
/**
 * ProductExportJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ProductExportJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductExportJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setProductStreamId($product_stream_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $product_stream_id))) {
            throw new \InvalidArgumentException("invalid value for $product_stream_id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setStorefrontSalesChannelId($storefront_sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $storefront_sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $storefront_sales_channel_id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelDomainId($sales_channel_domain_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_domain_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_domain_id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $currency_id))) {
            throw new \InvalidArgumentException("invalid value for $currency_id when calling ProductExportJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
