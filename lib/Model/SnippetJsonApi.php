...
/**
 * SnippetJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class SnippetJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SnippetJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SnippetJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSetId($set_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $set_id))) {
            throw new \InvalidArgumentException("invalid value for $set_id when calling SnippetJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
