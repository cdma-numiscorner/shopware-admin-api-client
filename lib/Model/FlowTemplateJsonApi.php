...
/**
 * FlowTemplateJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class FlowTemplateJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowTemplateJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling FlowTemplateJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
