...
/**
 * ThemeJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class ThemeJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ThemeJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ThemeJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPreviewMediaId($preview_media_id)
    {
        ...
        if (!is_null($preview_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $preview_media_id))) {
            throw new \InvalidArgumentException("invalid value for $preview_media_id when calling ThemeJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentThemeId($parent_theme_id)
    {
        ...
        if (!is_null($parent_theme_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_theme_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_theme_id when calling ThemeJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
