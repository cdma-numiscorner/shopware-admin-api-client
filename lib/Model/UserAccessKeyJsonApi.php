...
/**
 * UserAccessKeyJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class UserAccessKeyJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserAccessKeyJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling UserAccessKeyJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $user_id))) {
            throw new \InvalidArgumentException("invalid value for $user_id when calling UserAccessKeyJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
