...
/**
 * StateMachineHistoryJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class StateMachineHistoryJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StateMachineHistoryJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setStateMachineId($state_machine_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $state_machine_id))) {
            throw new \InvalidArgumentException("invalid value for $state_machine_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setFromStateId($from_state_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $from_state_id))) {
            throw new \InvalidArgumentException("invalid value for $from_state_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setToStateId($to_state_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $to_state_id))) {
            throw new \InvalidArgumentException("invalid value for $to_state_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUserId($user_id)
    {
        ...
        if (!is_null($user_id) && (!preg_match("/^[0-9a-f]{32}$/", $user_id))) {
            throw new \InvalidArgumentException("invalid value for $user_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setReferencedId($referenced_id)
    {
        ...
        if (!is_null($referenced_id) && (!preg_match("/^[0-9a-f]{32}$/", $referenced_id))) {
            throw new \InvalidArgumentException("invalid value for $referenced_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setReferencedVersionId($referenced_version_id)
    {
        ...
        if (!is_null($referenced_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $referenced_version_id))) {
            throw new \InvalidArgumentException("invalid value for $referenced_version_id when calling StateMachineHistoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
