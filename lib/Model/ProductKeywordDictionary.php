 ...
 */
class ProductKeywordDictionary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductKeywordDictionary';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling ProductKeywordDictionary., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling ProductKeywordDictionary., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
