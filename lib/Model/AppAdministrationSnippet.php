...
/**
 * AppAdministrationSnippet Class Doc Comment
 *
 * @category Class
 ...
 */
class AppAdministrationSnippet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppAdministrationSnippet';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling AppAdministrationSnippet., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling AppAdministrationSnippet., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLocaleId($locale_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $locale_id))) {
            throw new \InvalidArgumentException("invalid value for $locale_id when calling AppAdministrationSnippet., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
