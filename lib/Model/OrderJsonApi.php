 ...
 */
class OrderJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBillingAddressId($billing_address_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $billing_address_id))) {
            throw new \InvalidArgumentException("invalid value for $billing_address_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBillingAddressVersionId($billing_address_version_id)
    {
        ...
        if (!is_null($billing_address_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $billing_address_version_id))) {
            throw new \InvalidArgumentException("invalid value for $billing_address_version_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $currency_id))) {
            throw new \InvalidArgumentException("invalid value for $currency_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLanguageId($language_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $language_id))) {
            throw new \InvalidArgumentException("invalid value for $language_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setStateId($state_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $state_id))) {
            throw new \InvalidArgumentException("invalid value for $state_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCreatedById($created_by_id)
    {
        ...
        if (!is_null($created_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $created_by_id))) {
            throw new \InvalidArgumentException("invalid value for $created_by_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setUpdatedById($updated_by_id)
    {
        ...
        if (!is_null($updated_by_id) && (!preg_match("/^[0-9a-f]{32}$/", $updated_by_id))) {
            throw new \InvalidArgumentException("invalid value for $updated_by_id when calling OrderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
