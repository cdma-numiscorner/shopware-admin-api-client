 ...
 */
class OrderCustomerJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCustomerJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if (!is_null($customer_id) && (!preg_match("/^[0-9a-f]{32}$/", $customer_id))) {
            throw new \InvalidArgumentException("invalid value for $customer_id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $order_id))) {
            throw new \InvalidArgumentException("invalid value for $order_id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderVersionId($order_version_id)
    {
        ...
        if (!is_null($order_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $order_version_id))) {
            throw new \InvalidArgumentException("invalid value for $order_version_id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalutationId($salutation_id)
    {
        ...
        if (!is_null($salutation_id) && (!preg_match("/^[0-9a-f]{32}$/", $salutation_id))) {
            throw new \InvalidArgumentException("invalid value for $salutation_id when calling OrderCustomerJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
