...
/**
 * SalesChannelTypeJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SalesChannelTypeJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesChannelTypeJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\SalesChannelTypeJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling SalesChannelTypeJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\SalesChannelTypeJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\SalesChannelTypeJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
