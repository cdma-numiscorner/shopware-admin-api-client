...
/**
 * OrderLineItemDownloadJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderLineItemDownloadJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderLineItemDownloadJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderLineItemDownloadJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderLineItemDownloadJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemId($order_line_item_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $order_line_item_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_id when calling OrderLineItemDownloadJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemVersionId($order_line_item_version_id)
    {
        ...
        if (!is_null($order_line_item_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $order_line_item_version_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_version_id when calling OrderLineItemDownloadJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMediaId($media_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $media_id))) {
            throw new \InvalidArgumentException("invalid value for $media_id when calling OrderLineItemDownloadJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
