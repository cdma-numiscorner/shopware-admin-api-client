...
/**
 * CmsBlockJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class CmsBlockJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CmsBlockJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CmsBlockJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBackgroundMediaId($background_media_id)
    {
        ...
        if (!is_null($background_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $background_media_id))) {
            throw new \InvalidArgumentException("invalid value for $background_media_id when calling CmsBlockJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $section_id))) {
            throw new \InvalidArgumentException("invalid value for $section_id when calling CmsBlockJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling CmsBlockJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsSectionVersionId($cms_section_version_id)
    {
        ...
        if (!is_null($cms_section_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_section_version_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_section_version_id when calling CmsBlockJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
