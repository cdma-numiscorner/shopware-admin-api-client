 ...
 */
class FlowSequenceJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowSequenceJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling FlowSequenceJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setFlowId($flow_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $flow_id))) {
            throw new \InvalidArgumentException("invalid value for $flow_id when calling FlowSequenceJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setRuleId($rule_id)
    {
        ...
        if (!is_null($rule_id) && (!preg_match("/^[0-9a-f]{32}$/", $rule_id))) {
            throw new \InvalidArgumentException("invalid value for $rule_id when calling FlowSequenceJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_id when calling FlowSequenceJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppFlowActionId($app_flow_action_id)
    {
        ...
        if (!is_null($app_flow_action_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_flow_action_id))) {
            throw new \InvalidArgumentException("invalid value for $app_flow_action_id when calling FlowSequenceJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
