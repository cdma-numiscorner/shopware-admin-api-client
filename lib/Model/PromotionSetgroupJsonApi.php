 ...
 */
class PromotionSetgroupJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromotionSetgroupJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling PromotionSetgroupJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPromotionId($promotion_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $promotion_id))) {
            throw new \InvalidArgumentException("invalid value for $promotion_id when calling PromotionSetgroupJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
