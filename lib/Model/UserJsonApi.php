 ...
 */
class UserJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling UserJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLocaleId($locale_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $locale_id))) {
            throw new \InvalidArgumentException("invalid value for $locale_id when calling UserJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAvatarId($avatar_id)
    {
        ...
        if (!is_null($avatar_id) && (!preg_match("/^[0-9a-f]{32}$/", $avatar_id))) {
            throw new \InvalidArgumentException("invalid value for $avatar_id when calling UserJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
