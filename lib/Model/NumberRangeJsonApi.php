...
/**
 * NumberRangeJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class NumberRangeJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberRangeJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling NumberRangeJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTypeId($type_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $type_id))) {
            throw new \InvalidArgumentException("invalid value for $type_id when calling NumberRangeJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
