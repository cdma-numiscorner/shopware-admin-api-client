 ...
 */
class DocumentBaseConfigSalesChannelJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentBaseConfigSalesChannelJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling DocumentBaseConfigSalesChannelJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDocumentBaseConfigId($document_base_config_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $document_base_config_id))) {
            throw new \InvalidArgumentException("invalid value for $document_base_config_id when calling DocumentBaseConfigSalesChannelJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalesChannelId($sales_channel_id)
    {
        ...
        if (!is_null($sales_channel_id) && (!preg_match("/^[0-9a-f]{32}$/", $sales_channel_id))) {
            throw new \InvalidArgumentException("invalid value for $sales_channel_id when calling DocumentBaseConfigSalesChannelJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setDocumentTypeId($document_type_id)
    {
        ...
        if (!is_null($document_type_id) && (!preg_match("/^[0-9a-f]{32}$/", $document_type_id))) {
            throw new \InvalidArgumentException("invalid value for $document_type_id when calling DocumentBaseConfigSalesChannelJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
