 ...
 */
class IntegrationRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegrationRole';
    ...
    protected static $openAPITypes = [
        ...
        'role' => '\OpenAPI\ShopwareAdminApiClient\Model\AclRole'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling IntegrationRole., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setIntegrationId($integration_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $integration_id))) {
            throw new \InvalidArgumentException("invalid value for $integration_id when calling IntegrationRole., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAclRoleId($acl_role_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $acl_role_id))) {
            throw new \InvalidArgumentException("invalid value for $acl_role_id when calling IntegrationRole., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Sets role
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\AclRole|null $role role
     *
     * @return self
     */
