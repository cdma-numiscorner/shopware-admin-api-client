...
class CmsSection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'page' => '\OpenAPI\ShopwareAdminApiClient\Model\CmsPage',
        'background_media' => '\OpenAPI\ShopwareAdminApiClient\Model\Media',
        'blocks' => '\OpenAPI\ShopwareAdminApiClient\Model\CmsBlock[]'
    ];
     ...
     * Sets page
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CmsPage|null $page page
     *
     * @return self
     */
     ...
     * Sets blocks
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CmsBlock[]|null $blocks blocks
     *
     * @return self
     */
