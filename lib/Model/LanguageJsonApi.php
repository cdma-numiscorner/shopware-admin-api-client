...
/**
 * LanguageJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class LanguageJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LanguageJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling LanguageJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_id when calling LanguageJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLocaleId($locale_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $locale_id))) {
            throw new \InvalidArgumentException("invalid value for $locale_id when calling LanguageJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTranslationCodeId($translation_code_id)
    {
        ...
        if (!is_null($translation_code_id) && (!preg_match("/^[0-9a-f]{32}$/", $translation_code_id))) {
            throw new \InvalidArgumentException("invalid value for $translation_code_id when calling LanguageJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
