...
/**
 * TaxProviderJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class TaxProviderJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxProviderJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling TaxProviderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAvailabilityRuleId($availability_rule_id)
    {
        ...
        if (!is_null($availability_rule_id) && (!preg_match("/^[0-9a-f]{32}$/", $availability_rule_id))) {
            throw new \InvalidArgumentException("invalid value for $availability_rule_id when calling TaxProviderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if (!is_null($app_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling TaxProviderJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
