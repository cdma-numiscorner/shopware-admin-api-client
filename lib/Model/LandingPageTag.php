 ...
 */
class LandingPageTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LandingPageTag';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling LandingPageTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLandingPageId($landing_page_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $landing_page_id))) {
            throw new \InvalidArgumentException("invalid value for $landing_page_id when calling LandingPageTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setLandingPageVersionId($landing_page_version_id)
    {
        ...
        if (!is_null($landing_page_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $landing_page_version_id))) {
            throw new \InvalidArgumentException("invalid value for $landing_page_version_id when calling LandingPageTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTagId($tag_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $tag_id))) {
            throw new \InvalidArgumentException("invalid value for $tag_id when calling LandingPageTag., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
