 ...
 */
class NumberRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberRange';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'type' => '\OpenAPI\ShopwareAdminApiClient\Model\NumberRangeType',
        'number_range_sales_channels' => '\OpenAPI\ShopwareAdminApiClient\Model\NumberRangeSalesChannel[]',
        'state' => '\OpenAPI\ShopwareAdminApiClient\Model\NumberRangeState'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling NumberRange., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setTypeId($type_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $type_id))) {
            throw new \InvalidArgumentException("invalid value for $type_id when calling NumberRange., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\NumberRangeType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\NumberRangeType|null $type type
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\NumberRangeState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\NumberRangeState|null $state state
     *
     * @return self
     */
