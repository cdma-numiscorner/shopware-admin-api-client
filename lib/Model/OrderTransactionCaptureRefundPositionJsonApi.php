...
/**
 * OrderTransactionCaptureRefundPositionJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderTransactionCaptureRefundPositionJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTransactionCaptureRefundPositionJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setRefundId($refund_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $refund_id))) {
            throw new \InvalidArgumentException("invalid value for $refund_id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setRefundVersionId($refund_version_id)
    {
        ...
        if (!is_null($refund_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $refund_version_id))) {
            throw new \InvalidArgumentException("invalid value for $refund_version_id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemId($order_line_item_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $order_line_item_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOrderLineItemVersionId($order_line_item_version_id)
    {
        ...
        if (!is_null($order_line_item_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $order_line_item_version_id))) {
            throw new \InvalidArgumentException("invalid value for $order_line_item_version_id when calling OrderTransactionCaptureRefundPositionJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
