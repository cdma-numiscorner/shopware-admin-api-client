...
/**
 * AppShippingMethodJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class AppShippingMethodJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppShippingMethodJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling AppShippingMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if (!is_null($app_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling AppShippingMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setShippingMethodId($shipping_method_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $shipping_method_id))) {
            throw new \InvalidArgumentException("invalid value for $shipping_method_id when calling AppShippingMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setOriginalMediaId($original_media_id)
    {
        ...
        if (!is_null($original_media_id) && (!preg_match("/^[0-9a-f]{32}$/", $original_media_id))) {
            throw new \InvalidArgumentException("invalid value for $original_media_id when calling AppShippingMethodJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
