...
/**
 * CmsSlotJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CmsSlotJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CmsSlotJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\CmsSlotJsonApiAllOfRelationships'
    ];
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CmsSlotJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling CmsSlotJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setBlockId($block_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $block_id))) {
            throw new \InvalidArgumentException("invalid value for $block_id when calling CmsSlotJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsBlockVersionId($cms_block_version_id)
    {
        ...
        if (!is_null($cms_block_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_block_version_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_block_version_id when calling CmsSlotJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CmsSlotJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CmsSlotJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
