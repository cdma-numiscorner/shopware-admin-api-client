...
/**
 * OrderTransactionCaptureRefundJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderTransactionCaptureRefundJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTransactionCaptureRefundJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling OrderTransactionCaptureRefundJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling OrderTransactionCaptureRefundJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCaptureId($capture_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $capture_id))) {
            throw new \InvalidArgumentException("invalid value for $capture_id when calling OrderTransactionCaptureRefundJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCaptureVersionId($capture_version_id)
    {
        ...
        if (!is_null($capture_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $capture_version_id))) {
            throw new \InvalidArgumentException("invalid value for $capture_version_id when calling OrderTransactionCaptureRefundJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setStateId($state_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $state_id))) {
            throw new \InvalidArgumentException("invalid value for $state_id when calling OrderTransactionCaptureRefundJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
