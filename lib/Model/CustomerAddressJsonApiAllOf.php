...
/**
 * CustomerAddressJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerAddressJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerAddressJsonApi_allOf';
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CustomerAddressJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $customer_id))) {
            throw new \InvalidArgumentException("invalid value for $customer_id when calling CustomerAddressJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $country_id))) {
            throw new \InvalidArgumentException("invalid value for $country_id when calling CustomerAddressJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCountryStateId($country_state_id)
    {
        ...
        if (!is_null($country_state_id) && (!preg_match("/^[0-9a-f]{32}$/", $country_state_id))) {
            throw new \InvalidArgumentException("invalid value for $country_state_id when calling CustomerAddressJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setSalutationId($salutation_id)
    {
        ...
        if (!is_null($salutation_id) && (!preg_match("/^[0-9a-f]{32}$/", $salutation_id))) {
            throw new \InvalidArgumentException("invalid value for $salutation_id when calling CustomerAddressJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
