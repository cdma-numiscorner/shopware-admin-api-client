...
class InlineResponse20010 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets access_token
     *
     * @param string $access_token The access token that can be used for subsequent requests
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token The refresh token that can be used to refresh the access token. This field is not returned on grant type `refresh_token`.
     *
     * @return self
     */
