...
/**
 * TaxProviderJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class TaxProviderJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxProviderJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\TaxProviderJsonApiAllOfRelationships'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_url'] = $data['process_url'] ?? null;
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling TaxProviderJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    {
        return $this->container['process_url'];
    }

    /**
     * Sets process_url
     *
     * @param string|null $process_url process_url
     *
     * @return self
     */
    public function setProcessUrl($process_url)
    {
        $this->container['process_url'] = $process_url;
    ...
    public function setAvailabilityRuleId($availability_rule_id)
    {
        ...
        if (!is_null($availability_rule_id) && (!preg_match("/^[0-9a-f]{32}$/", $availability_rule_id))) {
            throw new \InvalidArgumentException("invalid value for $availability_rule_id when calling TaxProviderJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if (!is_null($app_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling TaxProviderJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\TaxProviderJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\TaxProviderJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
