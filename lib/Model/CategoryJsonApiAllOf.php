...
/**
 * CategoryJsonApiAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\ShopwareAdminApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CategoryJsonApiAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryJsonApi_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'custom_entity_type_id' => 'string',
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'translated' => 'object',
        'relationships' => '\OpenAPI\ShopwareAdminApiClient\Model\CategoryJsonApiAllOfRelationships'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'visible' => null,
        'active' => null,
        'cms_page_id_switched' => null,
        'visible_child_count' => 'int64',
        'name' => null,
        'custom_fields' => null,
        'slot_config' => null,
        'link_type' => null,
    ...
    protected static $attributeMap = [
        ...
        'visible' => 'visible',
        'active' => 'active',
        'cms_page_id_switched' => 'cmsPageIdSwitched',
        'visible_child_count' => 'visibleChildCount',
        'name' => 'name',
    ...
    protected static $setters = [
        ...
        'visible' => 'setVisible',
        'active' => 'setActive',
        'cms_page_id_switched' => 'setCmsPageIdSwitched',
        'visible_child_count' => 'setVisibleChildCount',
        'name' => 'setName',
        ...
        'custom_entity_type_id' => 'setCustomEntityTypeId',
    ...
    protected static $getters = [
        ...
        'visible' => 'getVisible',
        'active' => 'getActive',
        'cms_page_id_switched' => 'getCmsPageIdSwitched',
        'visible_child_count' => 'getVisibleChildCount',
        'name' => 'getName',
        ...
        'custom_entity_type_id' => 'getCustomEntityTypeId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cms_page_id_switched'] = $data['cms_page_id_switched'] ?? null;
        $this->container['visible_child_count'] = $data['visible_child_count'] ?? null;
        ...
        $this->container['custom_entity_type_id'] = $data['custom_entity_type_id'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['custom_entity_type_id']) && !preg_match("/^[0-9a-f]{32}$/", $this->container['custom_entity_type_id'])) {
            $invalidProperties[] = "invalid value for 'custom_entity_type_id', must be conform to the pattern /^[0-9a-f]{32}$/.";
        }
    ...
    public function setId($id)
    {
        ...
        if (!is_null($id) && (!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setVersionId($version_id)
    {
        ...
        if (!is_null($version_id) && (!preg_match("/^[0-9a-f]{32}$/", $version_id))) {
            throw new \InvalidArgumentException("invalid value for $version_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentId($parent_id)
    {
        ...
        if (!is_null($parent_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setParentVersionId($parent_version_id)
    {
        ...
        if (!is_null($parent_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $parent_version_id))) {
            throw new \InvalidArgumentException("invalid value for $parent_version_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAfterCategoryId($after_category_id)
    {
        ...
        if (!is_null($after_category_id) && (!preg_match("/^[0-9a-f]{32}$/", $after_category_id))) {
            throw new \InvalidArgumentException("invalid value for $after_category_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAfterCategoryVersionId($after_category_version_id)
    {
        ...
        if (!is_null($after_category_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $after_category_version_id))) {
            throw new \InvalidArgumentException("invalid value for $after_category_version_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setMediaId($media_id)
    {
        ...
        if (!is_null($media_id) && (!preg_match("/^[0-9a-f]{32}$/", $media_id))) {
            throw new \InvalidArgumentException("invalid value for $media_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    /**
     * Gets cms_page_id_switched
     *
     * @return bool|null
     */
    public function getCmsPageIdSwitched()
    {
        return $this->container['cms_page_id_switched'];
    }

    /**
     * Sets cms_page_id_switched
     *
     * @param bool|null $cms_page_id_switched Runtime field, cannot be used as part of the criteria.
     *
     * @return self
     */
    public function setCmsPageIdSwitched($cms_page_id_switched)
    {
        $this->container['cms_page_id_switched'] = $cms_page_id_switched;

        return $this;
    }

    /**
     * Gets visible_child_count
     *
     * @return int|null
     */
    public function getVisibleChildCount()
    {
        return $this->container['visible_child_count'];
    }

    /**
     * Sets visible_child_count
     *
     * @param int|null $visible_child_count Runtime field, cannot be used as part of the criteria.
     *
     * @return self
     */
    public function setVisibleChildCount($visible_child_count)
    {
        $this->container['visible_child_count'] = $visible_child_count;
    ...
    public function setInternalLink($internal_link)
    {
        ...
        if (!is_null($internal_link) && (!preg_match("/^[0-9a-f]{32}$/", $internal_link))) {
            throw new \InvalidArgumentException("invalid value for $internal_link when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsPageId($cms_page_id)
    {
        ...
        if (!is_null($cms_page_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_page_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_page_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setCmsPageVersionId($cms_page_version_id)
    {
        ...
        if (!is_null($cms_page_version_id) && (!preg_match("/^[0-9a-f]{32}$/", $cms_page_version_id))) {
            throw new \InvalidArgumentException("invalid value for $cms_page_version_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setProductStreamId($product_stream_id)
    {
        ...
        if (!is_null($product_stream_id) && (!preg_match("/^[0-9a-f]{32}$/", $product_stream_id))) {
            throw new \InvalidArgumentException("invalid value for $product_stream_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    /**
     * Gets custom_entity_type_id
     *
     * @return string|null
     */
    public function getCustomEntityTypeId()
    {
        return $this->container['custom_entity_type_id'];
    }

    /**
     * Sets custom_entity_type_id
     *
     * @param string|null $custom_entity_type_id custom_entity_type_id
     *
     * @return self
     */
    public function setCustomEntityTypeId($custom_entity_type_id)
    {

        if (!is_null($custom_entity_type_id) && (!preg_match("/^[0-9a-f]{32}$/", $custom_entity_type_id))) {
            throw new \InvalidArgumentException("invalid value for $custom_entity_type_id when calling CategoryJsonApiAllOf., must conform to the pattern /^[0-9a-f]{32}$/.");
        }

        $this->container['custom_entity_type_id'] = $custom_entity_type_id;
     ...
     * Gets relationships
     *
     * @return \OpenAPI\ShopwareAdminApiClient\Model\CategoryJsonApiAllOfRelationships|null
     */
     ...
     * Sets relationships
     *
     * @param \OpenAPI\ShopwareAdminApiClient\Model\CategoryJsonApiAllOfRelationships|null $relationships relationships
     *
     * @return self
     */
