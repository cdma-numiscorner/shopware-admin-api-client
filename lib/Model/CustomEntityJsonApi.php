...
/**
 * CustomEntityJsonApi Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEntityJsonApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomEntityJsonApi';
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[0-9a-f]{32}$/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling CustomEntityJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setAppId($app_id)
    {
        ...
        if (!is_null($app_id) && (!preg_match("/^[0-9a-f]{32}$/", $app_id))) {
            throw new \InvalidArgumentException("invalid value for $app_id when calling CustomEntityJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
    ...
    public function setPluginId($plugin_id)
    {
        ...
        if (!is_null($plugin_id) && (!preg_match("/^[0-9a-f]{32}$/", $plugin_id))) {
            throw new \InvalidArgumentException("invalid value for $plugin_id when calling CustomEntityJsonApi., must conform to the pattern /^[0-9a-f]{32}$/.");
        }
