# OpenAPI\ShopwareAdminApiClient\DocumentTypeApi
...
```php
createDocumentType($_response, $inline_object68): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\DocumentTypeApi(
...
$inline_object68 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject68(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject68

try {
    $result = $apiInstance->createDocumentType($_response, $inline_object68);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object68** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject68**](../Model/InlineObject68.md)|  | [optional]
...
```php
getDocumentTypeList($limit, $page, $query): Success
```
...
```php
updateDocumentType($id, $_response, $inline_object69): Success
```
...
$id = 'id_example'; // string | Identifier for the document_type
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object69 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject69(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject69

try {
    $result = $apiInstance->updateDocumentType($id, $_response, $inline_object69);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the document_type |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object69** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject69**](../Model/InlineObject69.md)|  | [optional]
