# OpenAPI\ShopwareAdminApiClient\CustomerAddressApi
...
```php
createCustomerAddress($_response, $inline_object50): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CustomerAddressApi(
...
$inline_object50 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject50(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject50

try {
    $result = $apiInstance->createCustomerAddress($_response, $inline_object50);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object50** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject50**](../Model/InlineObject50.md)|  | [optional]
...
```php
getCustomerAddressList($limit, $page, $query): Success
```
...
```php
updateCustomerAddress($id, $_response, $inline_object51): Success
```
...
$id = 'id_example'; // string | Identifier for the customer_address
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object51 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject51(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject51

try {
    $result = $apiInstance->updateCustomerAddress($id, $_response, $inline_object51);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the customer_address |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object51** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject51**](../Model/InlineObject51.md)|  | [optional]
