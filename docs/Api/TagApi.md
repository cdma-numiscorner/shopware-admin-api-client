# OpenAPI\ShopwareAdminApiClient\TagApi
...
```php
createTag($_response, $inline_object244): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\TagApi(
...
$inline_object244 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject244(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject244

try {
    $result = $apiInstance->createTag($_response, $inline_object244);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object244** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject244**](../Model/InlineObject244.md)|  | [optional]
...
$id = 'id_example'; // string | Identifier for the tag
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **string**| Identifier for the tag |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
```php
getTagList($limit, $page, $query): Success
```
...
```php
updateTag($id, $_response, $inline_object245): Success
```
...
$id = 'id_example'; // string | Identifier for the tag
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object245 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject245(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject245

try {
    $result = $apiInstance->updateTag($id, $_response, $inline_object245);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the tag |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object245** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject245**](../Model/InlineObject245.md)|  | [optional]
