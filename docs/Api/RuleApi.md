# OpenAPI\ShopwareAdminApiClient\RuleApi
...
```php
createRule($_response, $inline_object204): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\RuleApi(
...
$inline_object204 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject204(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject204

try {
    $result = $apiInstance->createRule($_response, $inline_object204);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object204** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject204**](../Model/InlineObject204.md)|  | [optional]
...
```php
getRuleList($limit, $page, $query): Success
```
...
```php
updateRule($id, $_response, $inline_object205): Success
```
...
$id = 'id_example'; // string | Identifier for the rule
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object205 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject205(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject205

try {
    $result = $apiInstance->updateRule($id, $_response, $inline_object205);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the rule |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object205** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject205**](../Model/InlineObject205.md)|  | [optional]
