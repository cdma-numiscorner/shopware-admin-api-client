# OpenAPI\ShopwareAdminApiClient\PromotionApi
...
```php
createPromotion($_response, $inline_object188): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\PromotionApi(
...
$inline_object188 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject188(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject188

try {
    $result = $apiInstance->createPromotion($_response, $inline_object188);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object188** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject188**](../Model/InlineObject188.md)|  | [optional]
...
```php
getPromotionList($limit, $page, $query): Success
```
...
```php
updatePromotion($id, $_response, $inline_object189): Success
```
...
$id = 'id_example'; // string | Identifier for the promotion
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object189 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject189(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject189

try {
    $result = $apiInstance->updatePromotion($id, $_response, $inline_object189);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the promotion |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object189** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject189**](../Model/InlineObject189.md)|  | [optional]
