# OpenAPI\ShopwareAdminApiClient\OrderApi
...
```php
createOrder($_response, $inline_object124): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\OrderApi(
...
$inline_object124 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject124(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject124

try {
    $result = $apiInstance->createOrder($_response, $inline_object124);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object124** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject124**](../Model/InlineObject124.md)|  | [optional]
...
```php
getOrderList($limit, $page, $query): Success
```
...
```php
updateOrder($id, $_response, $inline_object125): Success
```
...
$id = 'id_example'; // string | Identifier for the order
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object125 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject125(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject125

try {
    $result = $apiInstance->updateOrder($id, $_response, $inline_object125);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the order |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object125** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject125**](../Model/InlineObject125.md)|  | [optional]
