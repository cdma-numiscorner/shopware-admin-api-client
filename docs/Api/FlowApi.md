# OpenAPI\ShopwareAdminApiClient\FlowApi
...
```php
createFlow($_response, $inline_object70): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\FlowApi(
...
$inline_object70 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject70(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject70

try {
    $result = $apiInstance->createFlow($_response, $inline_object70);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object70** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject70**](../Model/InlineObject70.md)|  | [optional]
...
```php
getFlowList($limit, $page, $query): Success
```
...
```php
updateFlow($id, $_response, $inline_object71): Success
```
...
$id = 'id_example'; // string | Identifier for the flow
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object71 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject71(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject71

try {
    $result = $apiInstance->updateFlow($id, $_response, $inline_object71);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the flow |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object71** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject71**](../Model/InlineObject71.md)|  | [optional]
