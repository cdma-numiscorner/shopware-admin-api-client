# OpenAPI\ShopwareAdminApiClient\CmsBlockApi
...
```php
createCmsBlock($_response, $inline_object24): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CmsBlockApi(
...
$inline_object24 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject24(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject24

try {
    $result = $apiInstance->createCmsBlock($_response, $inline_object24);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object24** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject24**](../Model/InlineObject24.md)|  | [optional]
...
```php
getCmsBlockList($limit, $page, $query): Success
```
...
```php
updateCmsBlock($id, $_response, $inline_object25): Success
```
...
$id = 'id_example'; // string | Identifier for the cms_block
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object25 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject25(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject25

try {
    $result = $apiInstance->updateCmsBlock($id, $_response, $inline_object25);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the cms_block |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object25** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject25**](../Model/InlineObject25.md)|  | [optional]
