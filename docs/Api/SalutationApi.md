# OpenAPI\ShopwareAdminApiClient\SalutationApi
...
```php
createSalutation($_response, $inline_object216): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\SalutationApi(
...
$inline_object216 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject216(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject216

try {
    $result = $apiInstance->createSalutation($_response, $inline_object216);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object216** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject216**](../Model/InlineObject216.md)|  | [optional]
...
```php
getSalutationList($limit, $page, $query): Success
```
...
```php
updateSalutation($id, $_response, $inline_object217): Success
```
...
$id = 'id_example'; // string | Identifier for the salutation
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object217 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject217(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject217

try {
    $result = $apiInstance->updateSalutation($id, $_response, $inline_object217);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the salutation |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object217** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject217**](../Model/InlineObject217.md)|  | [optional]
