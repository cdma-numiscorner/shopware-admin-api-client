# OpenAPI\ShopwareAdminApiClient\PluginApi
...
```php
createPlugin($_response, $inline_object148): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\PluginApi(
...
$inline_object148 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject148(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject148

try {
    $result = $apiInstance->createPlugin($_response, $inline_object148);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object148** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject148**](../Model/InlineObject148.md)|  | [optional]
...
```php
getPluginList($limit, $page, $query): Success
```
...
```php
updatePlugin($id, $_response, $inline_object149): Success
```
...
$id = 'id_example'; // string | Identifier for the plugin
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object149 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject149(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject149

try {
    $result = $apiInstance->updatePlugin($id, $_response, $inline_object149);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the plugin |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object149** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject149**](../Model/InlineObject149.md)|  | [optional]
