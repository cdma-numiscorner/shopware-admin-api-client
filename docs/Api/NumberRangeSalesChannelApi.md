# OpenAPI\ShopwareAdminApiClient\NumberRangeSalesChannelApi
...
```php
createNumberRangeSalesChannel($_response, $inline_object118): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\NumberRangeSalesChannelApi(
...
$inline_object118 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject118(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject118

try {
    $result = $apiInstance->createNumberRangeSalesChannel($_response, $inline_object118);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object118** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject118**](../Model/InlineObject118.md)|  | [optional]
...
```php
getNumberRangeSalesChannel($id): Success
```
...
```php
getNumberRangeSalesChannelList($limit, $page, $query): Success
```
...
```php
updateNumberRangeSalesChannel($id, $_response, $inline_object119): Success
```
...
$id = 'id_example'; // string | Identifier for the number_range_sales_channel
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object119 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject119(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject119

try {
    $result = $apiInstance->updateNumberRangeSalesChannel($id, $_response, $inline_object119);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the number_range_sales_channel |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object119** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject119**](../Model/InlineObject119.md)|  | [optional]
