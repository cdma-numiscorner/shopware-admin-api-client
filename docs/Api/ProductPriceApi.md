# OpenAPI\ShopwareAdminApiClient\ProductPriceApi
...
```php
createProductPrice($_response, $inline_object170): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ProductPriceApi(
...
$inline_object170 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject170(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject170

try {
    $result = $apiInstance->createProductPrice($_response, $inline_object170);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object170** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject170**](../Model/InlineObject170.md)|  | [optional]
...
```php
getProductPriceList($limit, $page, $query): Success
```
...
```php
updateProductPrice($id, $_response, $inline_object171): Success
```
...
$id = 'id_example'; // string | Identifier for the product_price
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object171 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject171(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject171

try {
    $result = $apiInstance->updateProductPrice($id, $_response, $inline_object171);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the product_price |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object171** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject171**](../Model/InlineObject171.md)|  | [optional]
