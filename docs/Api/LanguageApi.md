# OpenAPI\ShopwareAdminApiClient\LanguageApi
...
```php
createLanguage($_response, $inline_object86): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\LanguageApi(
...
$inline_object86 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject86(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject86

try {
    $result = $apiInstance->createLanguage($_response, $inline_object86);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object86** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject86**](../Model/InlineObject86.md)|  | [optional]
...
```php
getLanguageList($limit, $page, $query): Success
```
...
```php
updateLanguage($id, $_response, $inline_object87): Success
```
...
$id = 'id_example'; // string | Identifier for the language
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object87 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject87(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject87

try {
    $result = $apiInstance->updateLanguage($id, $_response, $inline_object87);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the language |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object87** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject87**](../Model/InlineObject87.md)|  | [optional]
