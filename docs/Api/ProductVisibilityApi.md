# OpenAPI\ShopwareAdminApiClient\ProductVisibilityApi
...
```php
createProductVisibility($_response, $inline_object186): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ProductVisibilityApi(
...
$inline_object186 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject186(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject186

try {
    $result = $apiInstance->createProductVisibility($_response, $inline_object186);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object186** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject186**](../Model/InlineObject186.md)|  | [optional]
...
```php
getProductVisibility($id): Success
```
...
```php
getProductVisibilityList($limit, $page, $query): Success
```
...
```php
updateProductVisibility($id, $_response, $inline_object187): Success
```
...
$id = 'id_example'; // string | Identifier for the product_visibility
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object187 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject187(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject187

try {
    $result = $apiInstance->updateProductVisibility($id, $_response, $inline_object187);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the product_visibility |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object187** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject187**](../Model/InlineObject187.md)|  | [optional]
