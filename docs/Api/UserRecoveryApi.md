# OpenAPI\ShopwareAdminApiClient\UserRecoveryApi
...
```php
createUserRecovery($_response, $inline_object264): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\UserRecoveryApi(
...
$inline_object264 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject264(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject264

try {
    $result = $apiInstance->createUserRecovery($_response, $inline_object264);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object264** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject264**](../Model/InlineObject264.md)|  | [optional]
...
```php
getUserRecoveryList($limit, $page, $query): Success
```
...
```php
updateUserRecovery($id, $_response, $inline_object265): Success
```
...
$id = 'id_example'; // string | Identifier for the user_recovery
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object265 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject265(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject265

try {
    $result = $apiInstance->updateUserRecovery($id, $_response, $inline_object265);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the user_recovery |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object265** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject265**](../Model/InlineObject265.md)|  | [optional]
