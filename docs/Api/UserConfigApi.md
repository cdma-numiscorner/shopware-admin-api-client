# OpenAPI\ShopwareAdminApiClient\UserConfigApi
...
```php
createUserConfig($_response, $inline_object262): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\UserConfigApi(
...
$inline_object262 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject262(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject262

try {
    $result = $apiInstance->createUserConfig($_response, $inline_object262);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object262** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject262**](../Model/InlineObject262.md)|  | [optional]
...
```php
getUserConfigList($limit, $page, $query): Success
```
...
```php
updateUserConfig($id, $_response, $inline_object263): Success
```
...
$id = 'id_example'; // string | Identifier for the user_config
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object263 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject263(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject263

try {
    $result = $apiInstance->updateUserConfig($id, $_response, $inline_object263);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the user_config |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object263** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject263**](../Model/InlineObject263.md)|  | [optional]
