# OpenAPI\ShopwareAdminApiClient\CountryStateApi
...
```php
createCountryState($_response, $inline_object34): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CountryStateApi(
...
$inline_object34 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject34(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject34

try {
    $result = $apiInstance->createCountryState($_response, $inline_object34);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object34** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject34**](../Model/InlineObject34.md)|  | [optional]
...
```php
getCountryStateList($limit, $page, $query): Success
```
...
```php
updateCountryState($id, $_response, $inline_object35): Success
```
...
$id = 'id_example'; // string | Identifier for the country_state
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object35 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject35(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject35

try {
    $result = $apiInstance->updateCountryState($id, $_response, $inline_object35);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the country_state |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object35** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject35**](../Model/InlineObject35.md)|  | [optional]
