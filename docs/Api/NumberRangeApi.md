# OpenAPI\ShopwareAdminApiClient\NumberRangeApi
...
```php
createNumberRange($_response, $inline_object116): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\NumberRangeApi(
...
$inline_object116 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject116(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject116

try {
    $result = $apiInstance->createNumberRange($_response, $inline_object116);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object116** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject116**](../Model/InlineObject116.md)|  | [optional]
...
```php
getNumberRangeList($limit, $page, $query): Success
```
...
```php
updateNumberRange($id, $_response, $inline_object117): Success
```
...
$id = 'id_example'; // string | Identifier for the number_range
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object117 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject117(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject117

try {
    $result = $apiInstance->updateNumberRange($id, $_response, $inline_object117);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the number_range |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object117** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject117**](../Model/InlineObject117.md)|  | [optional]
