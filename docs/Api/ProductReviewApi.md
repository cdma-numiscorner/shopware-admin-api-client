# OpenAPI\ShopwareAdminApiClient\ProductReviewApi
...
```php
createProductReview($_response, $inline_object172): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ProductReviewApi(
...
$inline_object172 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject172(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject172

try {
    $result = $apiInstance->createProductReview($_response, $inline_object172);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object172** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject172**](../Model/InlineObject172.md)|  | [optional]
...
```php
getProductReviewList($limit, $page, $query): Success
```
...
```php
updateProductReview($id, $_response, $inline_object173): Success
```
...
$id = 'id_example'; // string | Identifier for the product_review
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object173 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject173(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject173

try {
    $result = $apiInstance->updateProductReview($id, $_response, $inline_object173);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the product_review |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object173** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject173**](../Model/InlineObject173.md)|  | [optional]
