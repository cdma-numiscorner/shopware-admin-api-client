# OpenAPI\ShopwareAdminApiClient\AppApi
...
```php
createApp($_response, $inline_object2): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\AppApi(
...
$inline_object2 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject2(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject2

try {
    $result = $apiInstance->createApp($_response, $inline_object2);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object2** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject2**](../Model/InlineObject2.md)|  | [optional]
...
```php
getAppList($limit, $page, $query): Success
```
...
```php
updateApp($id, $_response, $inline_object3): Success
```
...
$id = 'id_example'; // string | Identifier for the app
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object3 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject3(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject3

try {
    $result = $apiInstance->updateApp($id, $_response, $inline_object3);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the app |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object3** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject3**](../Model/InlineObject3.md)|  | [optional]
