# OpenAPI\ShopwareAdminApiClient\LocaleApi
...
```php
createLocale($_response, $inline_object88): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\LocaleApi(
...
$inline_object88 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject88(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject88

try {
    $result = $apiInstance->createLocale($_response, $inline_object88);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object88** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject88**](../Model/InlineObject88.md)|  | [optional]
...
```php
getLocaleList($limit, $page, $query): Success
```
...
```php
updateLocale($id, $_response, $inline_object89): Success
```
...
$id = 'id_example'; // string | Identifier for the locale
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object89 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject89(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject89

try {
    $result = $apiInstance->updateLocale($id, $_response, $inline_object89);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the locale |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object89** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject89**](../Model/InlineObject89.md)|  | [optional]
