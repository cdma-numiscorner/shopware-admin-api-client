# OpenAPI\ShopwareAdminApiClient\ScriptApi
...
```php
createScript($_response, $inline_object220): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ScriptApi(
...
$inline_object220 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject220(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject220

try {
    $result = $apiInstance->createScript($_response, $inline_object220);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object220** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject220**](../Model/InlineObject220.md)|  | [optional]
...
```php
getScriptList($limit, $page, $query): Success
```
...
```php
updateScript($id, $_response, $inline_object221): Success
```
...
$id = 'id_example'; // string | Identifier for the script
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object221 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject221(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject221

try {
    $result = $apiInstance->updateScript($id, $_response, $inline_object221);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the script |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object221** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject221**](../Model/InlineObject221.md)|  | [optional]
