# OpenAPI\ShopwareAdminApiClient\IntegrationApi
...
```php
createIntegration($_response, $inline_object82): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\IntegrationApi(
...
$inline_object82 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject82(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject82

try {
    $result = $apiInstance->createIntegration($_response, $inline_object82);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object82** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject82**](../Model/InlineObject82.md)|  | [optional]
...
```php
getIntegrationList($limit, $page, $query): Success
```
...
```php
updateIntegration($id, $_response, $inline_object83): Success
```
...
$id = 'id_example'; // string | Identifier for the integration
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object83 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject83(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject83

try {
    $result = $apiInstance->updateIntegration($id, $_response, $inline_object83);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the integration |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object83** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject83**](../Model/InlineObject83.md)|  | [optional]
