# OpenAPI\ShopwareAdminApiClient\DocumentApi
...
```php
createDocument($_response, $inline_object62): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\DocumentApi(
...
$inline_object62 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject62(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject62

try {
    $result = $apiInstance->createDocument($_response, $inline_object62);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object62** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject62**](../Model/InlineObject62.md)|  | [optional]
...
```php
getDocumentList($limit, $page, $query): Success
```
...
```php
updateDocument($id, $_response, $inline_object63): Success
```
...
$id = 'id_example'; // string | Identifier for the document
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object63 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject63(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject63

try {
    $result = $apiInstance->updateDocument($id, $_response, $inline_object63);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the document |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object63** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject63**](../Model/InlineObject63.md)|  | [optional]
