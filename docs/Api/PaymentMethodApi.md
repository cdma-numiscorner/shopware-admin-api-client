# OpenAPI\ShopwareAdminApiClient\PaymentMethodApi
...
```php
createPaymentMethod($_response, $inline_object146): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\PaymentMethodApi(
...
$inline_object146 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject146(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject146

try {
    $result = $apiInstance->createPaymentMethod($_response, $inline_object146);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object146** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject146**](../Model/InlineObject146.md)|  | [optional]
...
```php
getPaymentMethodList($limit, $page, $query): Success
```
...
```php
updatePaymentMethod($id, $_response, $inline_object147): Success
```
...
$id = 'id_example'; // string | Identifier for the payment_method
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object147 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject147(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject147

try {
    $result = $apiInstance->updatePaymentMethod($id, $_response, $inline_object147);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the payment_method |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object147** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject147**](../Model/InlineObject147.md)|  | [optional]
