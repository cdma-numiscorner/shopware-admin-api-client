# OpenAPI\ShopwareAdminApiClient\MailTemplateApi
...
```php
createMailTemplate($_response, $inline_object94): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\MailTemplateApi(
...
$inline_object94 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject94(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject94

try {
    $result = $apiInstance->createMailTemplate($_response, $inline_object94);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object94** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject94**](../Model/InlineObject94.md)|  | [optional]
...
```php
getMailTemplateList($limit, $page, $query): Success
```
...
```php
updateMailTemplate($id, $_response, $inline_object95): Success
```
...
$id = 'id_example'; // string | Identifier for the mail_template
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object95 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject95(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject95

try {
    $result = $apiInstance->updateMailTemplate($id, $_response, $inline_object95);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the mail_template |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object95** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject95**](../Model/InlineObject95.md)|  | [optional]
