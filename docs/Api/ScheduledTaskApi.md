# OpenAPI\ShopwareAdminApiClient\ScheduledTaskApi
...
```php
createScheduledTask($_response, $inline_object218): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ScheduledTaskApi(
...
$inline_object218 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject218(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject218

try {
    $result = $apiInstance->createScheduledTask($_response, $inline_object218);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object218** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject218**](../Model/InlineObject218.md)|  | [optional]
...
```php
getScheduledTaskList($limit, $page, $query): Success
```
...
```php
updateScheduledTask($id, $_response, $inline_object219): Success
```
...
$id = 'id_example'; // string | Identifier for the scheduled_task
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object219 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject219(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject219

try {
    $result = $apiInstance->updateScheduledTask($id, $_response, $inline_object219);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the scheduled_task |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object219** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject219**](../Model/InlineObject219.md)|  | [optional]
