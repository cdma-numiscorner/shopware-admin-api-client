# OpenAPI\ShopwareAdminApiClient\SalesChannelApi
...
```php
createSalesChannel($_response, $inline_object208): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\SalesChannelApi(
...
$inline_object208 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject208(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject208

try {
    $result = $apiInstance->createSalesChannel($_response, $inline_object208);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object208** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject208**](../Model/InlineObject208.md)|  | [optional]
...
```php
getSalesChannelList($limit, $page, $query): Success
```
...
```php
updateSalesChannel($id, $_response, $inline_object209): Success
```
...
$id = 'id_example'; // string | Identifier for the sales_channel
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object209 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject209(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject209

try {
    $result = $apiInstance->updateSalesChannel($id, $_response, $inline_object209);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the sales_channel |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object209** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject209**](../Model/InlineObject209.md)|  | [optional]
