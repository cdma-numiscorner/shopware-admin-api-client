# OpenAPI\ShopwareAdminApiClient\OrderAddressApi
...
```php
createOrderAddress($_response, $inline_object126): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\OrderAddressApi(
...
$inline_object126 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject126(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject126

try {
    $result = $apiInstance->createOrderAddress($_response, $inline_object126);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object126** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject126**](../Model/InlineObject126.md)|  | [optional]
...
```php
getOrderAddressList($limit, $page, $query): Success
```
...
```php
updateOrderAddress($id, $_response, $inline_object127): Success
```
...
$id = 'id_example'; // string | Identifier for the order_address
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object127 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject127(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject127

try {
    $result = $apiInstance->updateOrderAddress($id, $_response, $inline_object127);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the order_address |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object127** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject127**](../Model/InlineObject127.md)|  | [optional]
