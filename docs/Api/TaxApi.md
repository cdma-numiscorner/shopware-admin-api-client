# OpenAPI\ShopwareAdminApiClient\TaxApi
...
```php
createTax($_response, $inline_object246): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\TaxApi(
...
$inline_object246 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject246(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject246

try {
    $result = $apiInstance->createTax($_response, $inline_object246);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object246** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject246**](../Model/InlineObject246.md)|  | [optional]
...
```php
getTaxList($limit, $page, $query): Success
```
...
```php
updateTax($id, $_response, $inline_object247): Success
```
...
$id = 'id_example'; // string | Identifier for the tax
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object247 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject247(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject247

try {
    $result = $apiInstance->updateTax($id, $_response, $inline_object247);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the tax |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object247** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject247**](../Model/InlineObject247.md)|  | [optional]
