# OpenAPI\ShopwareAdminApiClient\OrderCustomerApi
...
```php
createOrderCustomer($_response, $inline_object128): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\OrderCustomerApi(
...
$inline_object128 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject128(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject128

try {
    $result = $apiInstance->createOrderCustomer($_response, $inline_object128);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object128** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject128**](../Model/InlineObject128.md)|  | [optional]
...
```php
getOrderCustomerList($limit, $page, $query): Success
```
...
```php
updateOrderCustomer($id, $_response, $inline_object129): Success
```
...
$id = 'id_example'; // string | Identifier for the order_customer
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object129 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject129(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject129

try {
    $result = $apiInstance->updateOrderCustomer($id, $_response, $inline_object129);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the order_customer |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object129** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject129**](../Model/InlineObject129.md)|  | [optional]
