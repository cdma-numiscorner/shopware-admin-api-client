# OpenAPI\ShopwareAdminApiClient\CustomFieldApi
...
```php
createCustomField($_response, $inline_object42): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CustomFieldApi(
...
$inline_object42 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject42(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject42

try {
    $result = $apiInstance->createCustomField($_response, $inline_object42);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object42** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject42**](../Model/InlineObject42.md)|  | [optional]
...
```php
getCustomFieldList($limit, $page, $query): Success
```
...
```php
updateCustomField($id, $_response, $inline_object43): Success
```
...
$id = 'id_example'; // string | Identifier for the custom_field
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object43 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject43(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject43

try {
    $result = $apiInstance->updateCustomField($id, $_response, $inline_object43);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the custom_field |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object43** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject43**](../Model/InlineObject43.md)|  | [optional]
