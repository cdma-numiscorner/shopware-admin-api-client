# OpenAPI\ShopwareAdminApiClient\UnitApi
...
```php
createUnit($_response, $inline_object256): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\UnitApi(
...
$inline_object256 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject256(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject256

try {
    $result = $apiInstance->createUnit($_response, $inline_object256);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object256** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject256**](../Model/InlineObject256.md)|  | [optional]
...
```php
getUnitList($limit, $page, $query): Success
```
...
```php
updateUnit($id, $_response, $inline_object257): Success
```
...
$id = 'id_example'; // string | Identifier for the unit
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object257 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject257(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject257

try {
    $result = $apiInstance->updateUnit($id, $_response, $inline_object257);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the unit |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object257** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject257**](../Model/InlineObject257.md)|  | [optional]
