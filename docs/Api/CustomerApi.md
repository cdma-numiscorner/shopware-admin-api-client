# OpenAPI\ShopwareAdminApiClient\CustomerApi
...
```php
createCustomer($_response, $inline_object48): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CustomerApi(
...
$inline_object48 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject48(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject48

try {
    $result = $apiInstance->createCustomer($_response, $inline_object48);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object48** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject48**](../Model/InlineObject48.md)|  | [optional]
...
```php
getCustomerList($limit, $page, $query): Success
```
...
```php
updateCustomer($id, $_response, $inline_object49): Success
```
...
$id = 'id_example'; // string | Identifier for the customer
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object49 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject49(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject49

try {
    $result = $apiInstance->updateCustomer($id, $_response, $inline_object49);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the customer |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object49** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject49**](../Model/InlineObject49.md)|  | [optional]
