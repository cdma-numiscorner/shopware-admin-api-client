# OpenAPI\ShopwareAdminApiClient\CurrencyApi
...
```php
createCurrency($_response, $inline_object36): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CurrencyApi(
...
$inline_object36 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject36(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject36

try {
    $result = $apiInstance->createCurrency($_response, $inline_object36);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object36** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject36**](../Model/InlineObject36.md)|  | [optional]
...
```php
getCurrencyList($limit, $page, $query): Success
```
...
```php
updateCurrency($id, $_response, $inline_object37): Success
```
...
$id = 'id_example'; // string | Identifier for the currency
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object37 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject37(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject37

try {
    $result = $apiInstance->updateCurrency($id, $_response, $inline_object37);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the currency |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object37** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject37**](../Model/InlineObject37.md)|  | [optional]
