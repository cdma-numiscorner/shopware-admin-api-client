# OpenAPI\ShopwareAdminApiClient\StateMachineApi
...
```php
createStateMachine($_response, $inline_object234): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\StateMachineApi(
...
$inline_object234 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject234(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject234

try {
    $result = $apiInstance->createStateMachine($_response, $inline_object234);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object234** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject234**](../Model/InlineObject234.md)|  | [optional]
...
```php
getStateMachineList($limit, $page, $query): Success
```
...
```php
updateStateMachine($id, $_response, $inline_object235): Success
```
...
$id = 'id_example'; // string | Identifier for the state_machine
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object235 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject235(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject235

try {
    $result = $apiInstance->updateStateMachine($id, $_response, $inline_object235);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the state_machine |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object235** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject235**](../Model/InlineObject235.md)|  | [optional]
