# OpenAPI\ShopwareAdminApiClient\UserAccessKeyApi
...
```php
createUserAccessKey($_response, $inline_object260): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\UserAccessKeyApi(
...
$inline_object260 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject260(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject260

try {
    $result = $apiInstance->createUserAccessKey($_response, $inline_object260);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object260** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject260**](../Model/InlineObject260.md)|  | [optional]
...
```php
getUserAccessKeyList($limit, $page, $query): Success
```
...
```php
updateUserAccessKey($id, $_response, $inline_object261): Success
```
...
$id = 'id_example'; // string | Identifier for the user_access_key
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object261 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject261(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject261

try {
    $result = $apiInstance->updateUserAccessKey($id, $_response, $inline_object261);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the user_access_key |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object261** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject261**](../Model/InlineObject261.md)|  | [optional]
