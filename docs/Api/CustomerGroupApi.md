# OpenAPI\ShopwareAdminApiClient\CustomerGroupApi
...
```php
createCustomerGroup($_response, $inline_object52): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CustomerGroupApi(
...
$inline_object52 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject52(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject52

try {
    $result = $apiInstance->createCustomerGroup($_response, $inline_object52);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object52** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject52**](../Model/InlineObject52.md)|  | [optional]
...
```php
getCustomerGroupList($limit, $page, $query): Success
```
...
```php
updateCustomerGroup($id, $_response, $inline_object53): Success
```
...
$id = 'id_example'; // string | Identifier for the customer_group
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object53 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject53(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject53

try {
    $result = $apiInstance->updateCustomerGroup($id, $_response, $inline_object53);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the customer_group |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object53** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject53**](../Model/InlineObject53.md)|  | [optional]
