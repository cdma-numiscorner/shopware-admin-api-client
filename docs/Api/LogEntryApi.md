# OpenAPI\ShopwareAdminApiClient\LogEntryApi
...
```php
createLogEntry($_response, $inline_object90): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\LogEntryApi(
...
$inline_object90 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject90(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject90

try {
    $result = $apiInstance->createLogEntry($_response, $inline_object90);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object90** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject90**](../Model/InlineObject90.md)|  | [optional]
...
```php
getLogEntryList($limit, $page, $query): Success
```
...
```php
updateLogEntry($id, $_response, $inline_object91): Success
```
...
$id = 'id_example'; // string | Identifier for the log_entry
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object91 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject91(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject91

try {
    $result = $apiInstance->updateLogEntry($id, $_response, $inline_object91);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the log_entry |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object91** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject91**](../Model/InlineObject91.md)|  | [optional]
