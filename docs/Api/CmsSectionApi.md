# OpenAPI\ShopwareAdminApiClient\CmsSectionApi
...
```php
createCmsSection($_response, $inline_object28): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CmsSectionApi(
...
$inline_object28 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject28(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject28

try {
    $result = $apiInstance->createCmsSection($_response, $inline_object28);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object28** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject28**](../Model/InlineObject28.md)|  | [optional]
...
```php
getCmsSectionList($limit, $page, $query): Success
```
...
```php
updateCmsSection($id, $_response, $inline_object29): Success
```
...
$id = 'id_example'; // string | Identifier for the cms_section
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object29 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject29(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject29

try {
    $result = $apiInstance->updateCmsSection($id, $_response, $inline_object29);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the cms_section |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object29** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject29**](../Model/InlineObject29.md)|  | [optional]
