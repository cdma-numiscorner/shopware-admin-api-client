# OpenAPI\ShopwareAdminApiClient\ProductApi
...
```php
createProduct($_response, $inline_object150): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ProductApi(
...
$inline_object150 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject150(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject150

try {
    $result = $apiInstance->createProduct($_response, $inline_object150);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object150** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject150**](../Model/InlineObject150.md)|  | [optional]
...
$id = 'id_example'; // string | Identifier for the product
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
...
```php
getProductList($limit, $page, $query): Success
```
...
```php
updateProduct($id, $_response, $inline_object151): Success
```
...
$id = 'id_example'; // string | Identifier for the product
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object151 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject151(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject151

try {
    $result = $apiInstance->updateProduct($id, $_response, $inline_object151);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the product |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object151** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject151**](../Model/InlineObject151.md)|  | [optional]
