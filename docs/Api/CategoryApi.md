# OpenAPI\ShopwareAdminApiClient\CategoryApi
...
```php
createCategory($_response, $inline_object22): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\CategoryApi(
...
$inline_object22 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject22(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject22

try {
    $result = $apiInstance->createCategory($_response, $inline_object22);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object22** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject22**](../Model/InlineObject22.md)|  | [optional]
...
$id = 'id_example'; // string | Identifier for the category
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
...
```php
getCategoryList($limit, $page, $query): Success
```
...
```php
updateCategory($id, $_response, $inline_object23): Success
```
...
$id = 'id_example'; // string | Identifier for the category
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object23 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject23(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject23

try {
    $result = $apiInstance->updateCategory($id, $_response, $inline_object23);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the category |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object23** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject23**](../Model/InlineObject23.md)|  | [optional]
