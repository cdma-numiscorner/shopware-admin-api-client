# OpenAPI\ShopwareAdminApiClient\ProductStreamApi
...
```php
createProductStream($_response, $inline_object182): Success
```
...
$apiInstance = new OpenAPI\ShopwareAdminApiClient\Api\ProductStreamApi(
...
$inline_object182 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject182(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject182

try {
    $result = $apiInstance->createProductStream($_response, $inline_object182);
    print_r($result);
} catch (Exception $e) {
 ...
 **inline_object182** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject182**](../Model/InlineObject182.md)|  | [optional]
...
```php
getProductStreamList($limit, $page, $query): Success
```
...
```php
updateProductStream($id, $_response, $inline_object183): Success
```
...
$id = 'id_example'; // string | Identifier for the product_stream
$_response = '_response_example'; // string | Data format for response. Empty if none is provided.
$inline_object183 = new \OpenAPI\ShopwareAdminApiClient\Model\InlineObject183(); // \OpenAPI\ShopwareAdminApiClient\Model\InlineObject183

try {
    $result = $apiInstance->updateProductStream($id, $_response, $inline_object183);
    print_r($result);
} catch (Exception $e) {
 ...
 **id** | **string**| Identifier for the product_stream |
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
 **inline_object183** | [**\OpenAPI\ShopwareAdminApiClient\Model\InlineObject183**](../Model/InlineObject183.md)|  | [optional]
